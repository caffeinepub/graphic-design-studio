...
export class Backend implements backendInterface {
    ...
    async getAllContactForms(arg0: Principal): Promise<Array<ContactForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactForms(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactForm(arg0: ContactFormData): Promise<void> {
        if (this.processError) {
            try {
